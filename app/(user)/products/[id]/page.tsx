...
const product = {
  ...
  images: ["/ph1.jpg", "/ph3.jpg", "/ph2.jpg", "/ph4.jpg"],
  sizes: ["XS", "S", "M", "L", "XL"],
  colors: ["#000000", "#8B4513", "#A52A2A"],
  description:
    "Experience luxury with our premium leather jacket. Crafted from the finest quality leather, this jacket offers both style and durability.",
  ...
  reviews: [
    {
      ...
      rating: 5,
      comment:
        "This jacket exceeded my expectations. The leather is soft yet durable, and the fit is perfect.",
    },
    {
      user: "Sarah M.",
      ...
      rating: 4,
      comment:
        "The jacket is beautiful, but I had to size up. Otherwise, it's a great purchase.",
    },
  ],
};
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="font-TwentiethCenturyforKenmoreLight">
                <strong className="font-thunder-lc text-2xl ">Care:</strong>{" "}
                {product.care}
              </p>
            </div>
