                         ...
                         >
                           <div className="relative group">
                             ...
                             <span
                               ...
                               className="absolute top-3 right-3 bg-gray-50/10 text-primary-foreground rounded-full flex items-center justify-center p-1 cursor-pointer group-hover:text-red-500 transition-colors duration-300"
                             >
                               <HeartIcon className="h-4 w-4 text-white group-hover:text-red-500 transition-colors duration-300" />
                             </span>
                           </div>
